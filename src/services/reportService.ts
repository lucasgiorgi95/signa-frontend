...
export class ReportService {
  ...
  static generateLowStockPDF(products: Product[], username: string) {
    ...
    doc.text(`Fecha: ${format(new Date(), 'dd/MM/yyyy HH:mm', { locale: es })}`, 20, 40);
  ...
  static generateLowStockExcel(products: Product[], username: string) {
    const data = products.map(product => ({
      ...
      'Estado': product.current_stock === 0 ? 'Sin stock' : 'Stock bajo',
      'Fecha Creación': format(new Date(product.created_at), 'dd/MM/yyyy')
    }));
    
    // Agregar información del reporte
    const reportInfo = [
      { 'Código': 'REPORTE DE STOCK BAJO', 'Producto': '', 'Stock Actual': '', 'Stock Mínimo': '', 'Estado': '', 'Fecha Creación': '' },
      { 'Código': `Generado por: ${username}`, 'Producto': '', 'Stock Actual': '', 'Stock Mínimo': '', 'Estado': '', 'Fecha Creación': '' },
      { 'Código': `Fecha: ${format(new Date(), 'dd/MM/yyyy HH:mm')}`, 'Producto': '', 'Stock Actual': '', 'Stock Mínimo': '', 'Estado': '', 'Fecha Creación': '' },
      { 'Código': `Total productos: ${products.length}`, 'Producto': '', 'Stock Actual': '', 'Stock Mínimo': '', 'Estado': '', 'Fecha Creación': '' },
      { 'Código': '', 'Producto': '', 'Stock Actual': '', 'Stock Mínimo': '', 'Estado': '', 'Fecha Creación': '' },
      ...data
    ];
  ...
  static generateInventoryPDF(products: Product[], username: string) {
    ...
    const tableData = products.map(product => [
      ...
      product.current_stock <= product.min_stock ? 'Stock bajo' : 'En stock'
    ]);
  ...
  static generateInventoryExcel(products: Product[], username: string) {
    const data = products.map(product => ({
      ...
      'Stock Actual': product.current_stock,
      'Stock Mínimo': product.min_stock,
      'Estado': product.current_stock === 0 ? 'Sin stock' : 
                product.current_stock <= product.min_stock ? 'Stock bajo' : 'En stock',
      'Fecha Creación': format(new Date(product.created_at), 'dd/MM/yyyy')
    }));
    ...
    // Agregar información del reporte
    const reportInfo = [
      { 'Código': 'INVENTARIO COMPLETO', 'Producto': '', 'Stock Actual': '', 'Stock Mínimo': '', 'Estado': '', 'Fecha Creación': '' },
      { 'Código': `Generado por: ${username}`, 'Producto': '', 'Stock Actual': '', 'Stock Mínimo': '', 'Estado': '', 'Fecha Creación': '' },
      { 'Código': `Fecha: ${format(new Date(), 'dd/MM/yyyy HH:mm')}`, 'Producto': '', 'Stock Actual': '', 'Stock Mínimo': '', 'Estado': '', 'Fecha Creación': '' },
      { 'Código': `Total productos: ${products.length}`, 'Producto': '', 'Stock Actual': '', 'Stock Mínimo': '', 'Estado': '', 'Fecha Creación': '' },
      { 'Código': `Total unidades: ${totalItems}`, 'Producto': '', 'Stock Actual': '', 'Stock Mínimo': '', 'Estado': '', 'Fecha Creación': '' },
      { 'Código': `Stock bajo: ${lowStockCount}`, 'Producto': '', 'Stock Actual': '', 'Stock Mínimo': '', 'Estado': '', 'Fecha Creación': '' },
      { 'Código': `Sin stock: ${outOfStockCount}`, 'Producto': '', 'Stock Actual': '', 'Stock Mínimo': '', 'Estado': '', 'Fecha Creación': '' },
      { 'Código': '', 'Producto': '', 'Stock Actual': '', 'Stock Mínimo': '', 'Estado': '', 'Fecha Creación': '' },
      ...data
    ];
    ...
    ws['!cols'] = [
      { wch: 15 }, { wch: 30 }, { wch: 12 }, { wch: 12 }, { wch: 12 }, { wch: 15 }
    ];
    
    XLSX.writeFile(wb, `inventario-completo-${format(new Date(), 'yyyy-MM-dd')}.xlsx`);
  }
  
  // Generar reporte de movimientos por período en PDF
  static generateMovementsPDF(movements: StockMovement[], dateFrom: string, dateTo: string, username: string) {
    const doc = new jsPDF();
    ...
    const ajustes = movements.filter(m => m.type === MovementType.ADJUST).length;
    
    doc.text(`Entradas: ${entradas} | Salidas: ${salidas} | Ajustes: ${ajustes}`, 20, 70);
    ...
    const tableData = movements.map(movement => [
      ...
      movement.product_id.substring(0, 8) + '...' // ID corto
    ]);
  ...
  static generateMovementsExcel(movements: StockMovement[], dateFrom: string, dateTo: string, username: string) {
    const data = movements.map(movement => ({
      'Fecha': format(new Date(movement.created_at), 'dd/MM/yyyy HH:mm'),
      'Tipo': movement.type === MovementType.IN ? 'Entrada' : 
              movement.type === MovementType.OUT ? 'Salida' : 'Ajuste',
    ...
    const reportInfo = [
      { 'Fecha': 'REPORTE DE MOVIMIENTOS', 'Tipo': '', 'Cantidad': '', 'Razón': '', 'Producto ID': '', 'Usuario ID': '' },
      { 'Fecha': `Generado por: ${username}`, 'Tipo': '', 'Cantidad': '', 'Razón': '', 'Producto ID': '', 'Usuario ID': '' },
      { 'Fecha': `Fecha: ${format(new Date(), 'dd/MM/yyyy HH:mm')}`, 'Tipo': '', 'Cantidad': '', 'Razón': '', 'Producto ID': '', 'Usuario ID': '' },
      { 'Fecha': `Período: ${dateFrom} - ${dateTo}`, 'Tipo': '', 'Cantidad': '', 'Razón': '', 'Producto ID': '', 'Usuario ID': '' },
      { 'Fecha': `Total movimientos: ${movements.length}`, 'Tipo': '', 'Cantidad': '', 'Razón': '', 'Producto ID': '', 'Usuario ID': '' },
      { 'Fecha': `Entradas: ${entradas}`, 'Tipo': '', 'Cantidad': '', 'Razón': '', 'Producto ID': '', 'Usuario ID': '' },
      { 'Fecha': `Salidas: ${salidas}`, 'Tipo': '', 'Cantidad': '', 'Razón': '', 'Producto ID': '', 'Usuario ID': '' },
      { 'Fecha': `Ajustes: ${ajustes}`, 'Tipo': '', 'Cantidad': '', 'Razón': '', 'Producto ID': '', 'Usuario ID': '' },
      { 'Fecha': '', 'Tipo': '', 'Cantidad': '', 'Razón': '', 'Producto ID': '', 'Usuario ID': '' },
      ...data
    ];
    ...
    ws['!cols'] = [
      { wch: 18 }, { wch: 10 }, { wch: 10 }, { wch: 25 }, { wch: 15 }, { wch: 15 }
    ];
